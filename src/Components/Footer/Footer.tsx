      ...
      <div className="site-footer__top ">
        <div className="site-footer__description">
          <div className='logos cursor'>
            ...
            <img className='img ' src='https://ucarecdn.com/c301e1a4-249e-4bab-bf1c-86c25a3dc398/279234257_691043618773985_3830166968954566921_n.jpg' alt="Pets Town Lebanon Logo" />
            </Link>
          </div>
